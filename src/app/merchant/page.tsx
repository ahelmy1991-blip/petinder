...
type Mode = "choice" | "login" | "register" | "step2";
      ...
      <div className="w-full max-w-md">
        ...
        {mode === "login" && (
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <button onClick={() => setMode("choice")} className="text-sm text-gray-400 hover:text-gray-600 mb-6 flex items-center gap-1">
              ← Back
            </button>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button type="submit" disabled={loginLoading}
                ...
                {loginLoading ? "Finding your account…" : "Access Dashboard →"}
              </button>
            </form>
          </div>
        )}
        ...
        {mode === "register" && (
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">You'll get a private link to manage your catalog and schedule.</p>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button type="submit" disabled={regLoading}
                ...
                {regLoading ? "Creating your profile…" : "Create Profile & Get My Link →"}
              </button>
            </form>
          </div>
        )}
